...
import '../../../../../data/models/order/order.dart'
    show VehicleType, VehicleTypeLabel;
...
class DriverProfileTab extends StatelessWidget {
  ...
  Future<void> _launchHelpCenter(BuildContext context) async {
    final subject = Uri.encodeComponent(
      context.l10n.profileEmailSupportSubject,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final vehicleString =
        (user.vehicleModel?.isNotEmpty ?? false) ||
            (user.vehicleColor?.isNotEmpty ?? false)
          ...
          child: Column(
            ...
            children: [
              ProfileHeader(
                ...
                avatarInitial: user.name.isNotEmpty
                    ? user.name[0]
                    : context.l10n.profileAvatarFallback,
              ...
              ProfileStatCard(
                stats: [
                  ...
                  ProfileStat(
                    value:
                        '${vm.totalEarnings.toStringAsFixed(1)} ${context.l10n.currencyJodShort}',
              ...
              ProfileTile(
                ...
                label: context.l10n.profileVehicle,
                value: vehicleString,
                showArrow: true,
              ),
              ProfileTile(
                icon: Icons.pin_rounded,
                label: context.l10n.profileLicensePlate,
                value: user.licensePlate ?? context.l10n.profileAddLicensePlate,
                valueLtr: true,
              ),
              if (user.vehiclePhotoPath != null &&
                  user.vehiclePhotoPath!.isNotEmpty)
                Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () => Navigator.of(context).push(
            MaterialPageRoute(builder: (_) => RewardsView(userId: userId)),
          ),
          child: Container(
...
class _EditVehicleBottomSheetState extends State<_EditVehicleBottomSheet> {
  ...
  void _save() {
    widget.viewModel.updateVehicleInfo(
      vehicleModel: _modelController.text.trim().isNotEmpty
          ? _modelController.text.trim()
          : null,
      vehicleColor: _colorController.text.trim().isNotEmpty
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      context.l10n.profileVehicleTypeLabel(_vehicleType!.label),
                      style: GoogleFonts.cairo(
                        fontSize: 13,
                        fontWeight: FontWeight.bold,
            ...
            const SizedBox(height: 20),
            _buildTextField(
              label: context.l10n.profileVehicleTypeModel,
              controller: _modelController,
              hint: context.l10n.profileVehicleTypeModelHint,
            ),
            const SizedBox(height: 16),
            _buildTextField(
              label: context.l10n.profileVehicleColor,
              controller: _colorController,
              hint: context.l10n.profileVehicleColorHint,
            ),
            const SizedBox(height: 16),
            _buildTextField(
