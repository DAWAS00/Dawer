          ...
          SliverToBoxAdapter(
            child: Column(
              children: [
                ...
                ProfileStatCard(
                  stats: [
                    ProfileStat(value: vm.totalShipments.toString(), label: context.l10n.recyclingReceivedShipments),
                    ProfileStat(value: _formatNumber(vm.totalWeightProcessed), label: context.l10n.recyclingProcessedWeight),
                    ProfileStat(value: vm.activeJobs.toString(), label: context.l10n.recyclingActiveJobsLabel),
                  ],
                ),
                ...
                ProfileTile(icon: Icons.phone_rounded, label: context.l10n.recyclingCompanyPhone, value: company.phone, valueLtr: true),
                ProfileTile(icon: Icons.location_on_rounded, label: context.l10n.recyclingServiceArea, value: vm.serviceArea),
                ProfileTile(icon: Icons.access_time_rounded, label: context.l10n.recyclingWorkingHours, value: vm.workingHours),
                ProfileTile(
                  icon: Icons.badge_rounded,
                  label: context.l10n.recyclingLicense,
                  value: company.isVerified ? '${context.l10n.recyclingLicenseVerified}  ·  ${vm.licenseNumber}' : context.l10n.recyclingLicenseNotVerified,
                ...
                ProfileActionTile(icon: Icons.delete_forever_rounded, title: context.l10n.profileDeleteAccount, color: Colors.red.shade700, onTap: () {}),
