...
class _ImagePlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Icon(Icons.image_rounded, size: 40, color: context.dt.onSurfaceMuted),
    );
  }
}
          ...
          Row(
            ...
            children: [
              Icon(Icons.location_on_rounded,
                  size: 18, color: isMine ? Colors.white70 : accent),
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.open_in_new_rounded,
                      size: 12, color: isMine ? Colors.white : accent),
