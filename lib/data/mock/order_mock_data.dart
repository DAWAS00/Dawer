...
class OrderMockData {
  static List<Order> seedOrders() => [
    ...
    Order(
      ...
      arrivedAtPickupAt: DateTime.now().subtract(
    ...
    Order(
      ...
      inTransitAt: DateTime.now().subtract(
        const Duration(days: 1, minutes: 40),
      ),
  ...
  static List<Order> seedMarketItems() => [
    ...
    Order(
      ...
      images: ['https://picsum.photos/seed/mkt003a/600/400'],
      isMarketplaceShared: true,
    ),
    Order(
      id: 'MKT-004',
